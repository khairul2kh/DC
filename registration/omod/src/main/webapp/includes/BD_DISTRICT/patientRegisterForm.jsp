...
<script type="text/javascript">
    ...
    PAGE = {
        ...
        submit: function() {
            ...
            jQuery('#selectedRmpId option').each(function(i) {
                jQuery(this).attr("selected", "selected");
            });
            ...
            if (this.validateRegisterForm()) {
                jQuery("#patientRegistrationForm")
                        .mask("<img src='" + openmrsContextPath + "/moduleResources/hospitalcore/ajax-loader.gif" + "'/>&nbsp;");
                jQuery("#patientRegistrationForm")
                        .ajaxSubmit(
                                {
                                    success: function(responseText, statusText, xhr) {
                                        ...
                                        if (json.status == "success") {
                                            window.location.href = openmrsContextPath
                                                    + "/module/billing/billorder.form?patientId="
                                                    + json.patientId
                                                    + "&refDocId="
                                                    + json.refDocId
                                                    + "&refMarId="
            ...
            <td class="cell">dd/mm/yyyy<br />
                <table>
                    ...
                    <tr>
                        ...
                        <td><select  style="height:30px;" id="patientGender" name="patient.gender">
