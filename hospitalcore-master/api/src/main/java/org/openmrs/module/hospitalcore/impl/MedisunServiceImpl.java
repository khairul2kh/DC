...
public class MedisunServiceImpl extends BaseOpenmrsService implements MedisunService {
    ...
    public List<DiaCommissionCal> getDiaComCalRmp(int rmpId, Date sDate, Date eDate) throws APIException {
        return dao.getDiaComCal(rmpId, sDate, eDate);
    }
    ...
    public List<DiaCommissionCal> getDiaComCalRmpPay(int rmpId, Date sDate, Date eDate) throws APIException {
        return dao.getDiaComCalRmpPay(rmpId, sDate, eDate);
    }

    public List<DiaCommissionCal> listDiaComCal(int dc, Date sDate, Date eDate) throws APIException {
        return dao.listDiaComCal(dc, sDate, eDate);
    }
    ...
    public List<DiaCommissionCal> getDiaComListById(int id) throws APIException {
        return dao.getDiaComCalByBillId(id);
    }

    public DiaCommissionCal getDiaComByBillId(int billId) throws APIException {
        return dao.getDiaComByBillId(billId);
    }
    ...
    public List<DiaCommissionCal> listDiaComCalGroupByBillId(int docId, int docch, Date sDate, Date eDate) throws APIException {
        return dao.listDiaComCalGroupByBillId(docId, docch, sDate, eDate);
    }
