...
<script type="text/javascript">
    ...
    PATIENTSEARCH = {
        ...
        buildQuery: function() {
            ...
            this.whereClause += " (ps.identifier LIKE '%" + nameOrIdentifier + "%' OR ps.fullname LIKE '%" + nameOrIdentifier + "%' OR ps.middle_name LIKE '%" + nameOrIdentifier + "%')";
            ...
            if (value.length >= 3) {
                ...
                for (i = 0; i < value.length; i++) {
                    if (pattern.indexOf(value[i]) < 0) {
                        jQuery("#errorList", this.form).append("<li>Please enter patient name/identifier in correct format aaaaaa!</li>");
                        return false;
                    }
                }
                return true;
...
<form id="patientSearchForm" style="font-size:12px;">
    <div id="errorSection">
    ...
    <table cellspacing="10">
        <tr>	
            <td>Name/Id</td>
            <td><input id="nameOrIdentifier" class="form-control" style="width:200px;"/></td>
