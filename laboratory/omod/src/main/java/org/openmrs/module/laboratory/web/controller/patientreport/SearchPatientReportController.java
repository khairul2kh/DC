...
public class SearchPatientReportController {
    ...
    public String searchTest(
        ...
        try {
            ...
            for (LabTest test : te) {
                ...
                if ((test.getEncounter().getId() != null) && (test.getConcept().getConceptClass().getName().equalsIgnoreCase("LabSet"))
                        ...
                        || (test.getConcept().getId() == 2617) || (test.getConcept().getId() == 5153)
                        || (test.getConcept().getId() == 2615)
      ...
      //  return "/module/laboratory/patientreport/search";
        ...
        } else if (investigation.equals("2410") || investigation.equals("2543") || investigation.equals("5718")) {
