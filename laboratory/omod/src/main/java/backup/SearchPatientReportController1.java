//package backup;
//
//import org.openmrs.module.laboratory.web.controller.patientreport.*;
...
//public class SearchPatientReportController1 {
//
...
//                        || (test.getConcept().getId() == 2617) || (test.getConcept().getId() == 6399)
//                        || (test.getConcept().getId() == 5153) || (test.getConcept().getId() == 2615)
//                        || (test.getConcept().getId() == 2614)
//                        //Serelogy filter here 
//                        || (test.getConcept().getId() == 3967) || (test.getConcept().getId() == 4256)
//                        || (test.getConcept().getId() == 5242) || (test.getConcept().getId() == 5218)
...
//        
////        if (investigation.equals("2311")) {
////            return "/module/laboratory/patientreport/search_bio"; // Biochemistry
////        } else if ((investigation.equals("5216")) || (investigation.equals("3092")) || (investigation.equals("5225"))
////                || (investigation.equals("5692")) || (investigation.equals("5148")) || (investigation.equals("4252"))
////                || (investigation.equals("3937")) || (investigation.equals("5158")) || (investigation.equals("2413"))
////                || (investigation.equals("5153")) || (investigation.equals("2615")) || (investigation.equals("2614")) ) 
////        {          // Anti-Nuclear Ab (ANA), BETA hCG, Complement 3 (C3) (C4), BT/CT, Ketone body - Urine, Urinary Total Protein, Creatinine Clearance Rate (CCR)
////            return "/module/laboratory/patientreport/search_single";
////        } else if (investigation.equals("3945")) {
