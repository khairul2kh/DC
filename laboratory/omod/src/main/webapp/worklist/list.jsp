...
<script type="text/javascript">
	...
	function submit(testId){
		if(confirm("Are you sure !")) {
			jQuery(".bu-normal").hide();
			jQuery(".resultParameter").mask("<img src='" + openmrsContextPath + "/moduleResources/laboratory/spinner.gif" + "'/>&nbsp;");
...
<div class="boxHeader"> <strong>See patient List by choosing lab</strong> </div>
<div class="box">
	Date:
