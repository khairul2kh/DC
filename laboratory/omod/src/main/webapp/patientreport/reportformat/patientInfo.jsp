                ...
                <c:forEach var="test" items="${investigation}">
                    <c:choose>
                        ...
                        <c:when test="${investigation eq '2543' || investigation eq '2577' || 
                                        investigation eq '5158' || investigation eq '3693' ||
                                        investigation eq '6399' || investigation eq '2410'}">
                                Blood
                        </c:when>
                        ...
                        <c:when test="${investigation eq '5142'}">
                            ...
                            <c:forEach items="${te}" var="t">
                                ...
                                <c:if test="${t.concept.conceptId eq '5377'}"> Stool </c:if>
                                <c:if test="${t.concept.conceptId eq '4941'}"> Skin </c:if>
                                <c:if test="${t.concept.conceptId eq '3125'}"> Stool </c:if>
