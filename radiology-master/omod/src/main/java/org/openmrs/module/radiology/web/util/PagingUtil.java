...
public class PagingUtil {
    ...
    static AdministrationService administrationService = Context.getAdministrationService();
    static String driveLocation = administrationService.getGlobalProperty("radiology.template.drive");

    public static final String DRIVER_LOCATION = driveLocation;
