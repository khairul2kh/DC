        ...
        <tbody>
            ...
            <c:forEach var="sol" items="${diaBillItemList}" varStatus="index">
                    ...
                    <tr class="${klass}" id="">
                        ...
                        <td align="right">
                            <input type="text" id="${index.count}unitprice" name="${index.count}unitprice" class="normaltext" style="width:150px;"
                                   size="7" value="${sol.amount}" class="unitPriTube" readOnly="true"></td>
                        </td>

                        <td align="right" style="display:none;">
                            <input type="text" id="${index.count}serviceprice" name="${index.count}serviceprice" class="normaltext" style="width:150px;"
                                   size="7" value="${sol.amount}" class="serpricalc" readOnly="true"></td>
                        </td>
                ...
                <c:if test="${sol.service.commission eq '0'}" >
                    ...
                    <c:set var="tubeprice" value="${sol.unitPrice}"/>
                    ...
                    <tr class="${klass}" id="">
                        ...
                        <td align="right">
                            <input type="text" id="${index.count}unitprice" name="${index.count}unitprice" class="normaltext" style="width:150px;"
                                   size="7" value="${sol.unitPrice}" class="unitPri" readOnly="true">
                        </td>
                    </tr>
            ...
            <table border="1" width="90%;"   >
                ...
                <tr>
                    ...
                    <td align="center">  <input type="text" id="disAmounut" name="disAmounut" size="7" value="${dpsb.discountAmount}" readOnly="true" 
                                                style="width:100px; background:#D1E0E0; text-align:center; font-size:18px; font-weight:bold; " />
                ...
                <tr >
                    <td colspan="10" align="right"><span style="font-size:18px; font-weight:bold; color:#cc6600;"> Due Amount (Tk) :</span> &nbsp;</td>
                    <td align="center"><input type="text" id="netamount" name="netamount"  value="${dpsb.dueAmount}"
                                              style="width:100px; font-size:18px; background:#D1E0E0; font-weight:bold; color:#cc6600; text-align:center;" 
                ...
                <tr>
                    ...
                    <td align="center">
                        <input type="text" id="paidamount" name="paidamount"  placeholder="Cash Paid" onkeypress="return isNumberKey(event)" 
                               style="width:150px; height:40px; color:blue; font-weight:bold; font-size:20px; text-align:center;"   
