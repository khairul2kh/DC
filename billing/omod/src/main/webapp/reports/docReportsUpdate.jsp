<%-- 
    Document   : docReportsUpdate
    Created on : Jul 24, 2016, 12:10:07 PM
    Author     : Khairul
--%>
...
<form class="form-rep-view"  method="post" action="docRepUpdate.htm" style="width:90%; margin-left:40px;" >
    <input type="hidden" id="id" name="id" value="${comPaid.id}" />
    <div class="boxHeader1">   <strong>Doctor Commission Payment Update</strong></div>
    <div class="box1">
        <br>
        <table style="font-size:17px;  font-family: 'Times New Roman';" class="table_data table-striped" >
            ...
            <tr>
                <td width="50%" height="30px;"> Doctor Payable / Commission Amount : </td> 
                <td> ${comPaid.docCommission}    </td>
            </tr>
            <tr>
