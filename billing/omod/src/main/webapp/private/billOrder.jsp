...
<form class="kha-aero">
	<h1 style="font-size:15px;"> Bill Order </h1>

    <div style="float:left; width:50%; padding:0px 0px 0px 0px;">
        <fieldset class="fieldset1">
            <legend  style="padding: 0.1em 0.3em;  border:1px solid green;  color:green;  font-size:14px; text-align:right;"> Patient Information</legend> 
            <table style="width:100%;">
                <tr> 
                    <td>Patient Name :   <span style="font-weight:bold; font-size:14px; color:blue;">
                            ${patient.givenName} ${patient.middleName} ${patient.familyName}</span> <td>

                    <td>Patient ID : <span style="font-weight:bold; font-size:14px; color:blue;">
    ...
    <div style="float:left; width:50%;   padding:0px 0px 0px 20px;">
        <fieldset class="fieldset2">
            ...
            <table style="width:95%;">
                <tr> 
                    <td>Referred Dr : <span style="font-weight:bold; font-size:14px;"> ${docInfo.doctorName} </span>  </td>
                    </tr>  
                    <tr> 
                    ...
                    <c:if test="${docInfo.doctorName ne null}">
                        <td style="display:none;">Order Id: <span style="font-weight:bold; font-size:20px; color:red;"> ${orderId} </span> </td> </c:if>
                    </tr> 
                </table>
            </fieldset>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("input").blur(function() {
                $(this).css("background-color", "#e8e8");
                $(this).css("color", "#000");
            });
        })
    ...
    <h1 style="font-size:15px;"> Bill Details</h1>
    <b>&nbsp;&nbsp;&nbsp;&nbsp; Service Name : </b>
            ...
            <td>
                <div style="overflow:hidden; display:inline-block; line-height: 200%; " >
                    <select id="selectedTestId"    name="selectedTestId"  style="width:1100px;  
                            ...
                            margin:-5px -30px -5px -5px; scrolling:no; font-size:16px; " size="10" multiple="multiple" 
