...
//
//            // File outputFilePatId = new File("F:\\tomcat6(OpenMRS)\\webapps\\MEDISUN_HEALTH_CARE_V2_Final\\barcode/" + patient.getId() + ".png");
...
//          //  File outputFileBillId = new File("D:\\tomcat6\\webapps\\CAP\\barcode/" + dpsb.getBillId() + ".png");  // CNP
//
