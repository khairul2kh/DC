...
public class RmpCommissionPayment {
    ...
    public String getCommision(HttpServletRequest request,
        ...
        List<DiaCommissionCal> diaComCal = ms.getDiaComCalRmpPay(rmpId, date, date1);
        ...
        if (docch == 2) {
            ...
            List<DiaCommissionCal> listBillIdGroup = ms.listDiaComCalGroupByBillId(rmpId, docch, date, date1);
